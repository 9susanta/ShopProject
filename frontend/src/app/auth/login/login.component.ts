...
export class LoginComponent implements OnInit, OnDestroy {
  ...
  async onSubmit(): Promise<void> {
    ...
    try {
      ...
      // Verify authentication immediately after login response
      // The auth service sets state synchronously in the tap operator
      ...
      if (isAuthenticated && user) {
        ...
        // Navigate immediately - auth state is already set synchronously
        // Use navigateByUrl for reliable navigation
